...
const PORT = 41952;
const CASES = [
  { situationId: "SIT137", templateId: "T04", label: "natural" },
  { situationId: "SIT005", templateId: "T04", label: "stress" },
  { situationId: "SIT001", templateId: "T04", label: "stress" },
  { situationId: "SIT046", templateId: "T04", label: "stress" },
  { situationId: "SIT028", templateId: "T04", label: "stress" }
];
const CONTENT_TYPES = {
