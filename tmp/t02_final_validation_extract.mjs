...
const PORT = 41942;
const CASES = [
  { situationId: "SIT006", templateId: "T02", label: "stress" },
  { situationId: "SIT054", templateId: "T02", label: "natural" },
  { situationId: "SIT102", templateId: "T02", label: "natural" },
  { situationId: "SIT124", templateId: "T02", label: "natural" },
  { situationId: "SIT168", templateId: "T02", label: "natural" }
];
const CONTENT_TYPES = {
...
async function runCase(page, testCase) {
  return page.evaluate(async ({ situationId, templateId, label }) => {
    ...
    return {
      ...
      eventActions: artifacts && artifacts.eventChainResult && artifacts.eventChainResult.events
        ? artifacts.eventChainResult.events.map((e) => ({ label: e.label, action: e.action || e.reinterpretation || "" }))
        : []
    };
  }, testCase);
}
