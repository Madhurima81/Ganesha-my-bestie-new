...
const shouldEnableHints = () => {
  ...
  // Also disable if games are active
  if (sceneState?.showEyesTelescopeGame || sceneState?.showEarsRhythmGame) {
    return false;
  }
    ...
    {musicalNoteData.map((noteData, index) => {
      ...
      return (
        <div 
          key={noteData.id}
          onClick={() => {
            // ✅ CLICK HANDLER: Only works if golden and tusk game active
