...
<button 
  onClick={() => {
    ...
    if (currentMissionSymbol === 'lotus') {
      sceneActions.updateState({ 
        ...
        lotusStates: [0, 0, 0],  // ⭐ Reset all 3 lotuses to unbloom
        goldenLotusVisible: false,
        goldenLotusBloom: false
      });
  ...
  sceneActions.updateState({ 
    phase: PHASES.GOLDEN_VISIBLE,
    lotusStates: [1, 1, 1],  // ⭐ Keep the 3 pink lotuses BLOOMED
    goldenLotusVisible: true,  // ⭐ Golden lotus visible
    goldenLotusBloom: false,  // ⭐ IMPORTANT: Golden lotus is a BUD (not bloomed yet!)
    elephantVisible: false,
    elephantTransformed: false,
    trunkActive: false,
    waterDrops: [],
