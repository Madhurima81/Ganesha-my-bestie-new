...
const getHintConfigs = () => [
  {
    ...
    condition: (sceneState) => {
      ...
      // Only show if we're in lotus phase
  ...
  },
  {
    ...
    condition: (sceneState) => {
      if (!sceneState) return false;
      // PRIORITY: Elephant hint comes BEFORE golden lotus hint
  ...
  },
  {
    ...
    condition: (sceneState) => {
      if (!sceneState) return false;
      // Only show if elephant is NOT active
...
{sceneState.phase === PHASES.INITIAL && !sceneState.welcomeShown && (
  <>
    {/* Gentle glow on background lotus */}
    <div style={{
      position: 'absolute',
      left: '35%',
      top: '45%',
...
<div style={{
  ...
  <img src={goldenLotusClosed} alt="Golden Lotus" style={{width: '12%', opacity: 0.9}} />
</div>
*/}
    ...
    <div style={{
      ...
      <div style={{
        ...
        Discover the magical lotus flowers!
      </div>
      ...
      <div style={{
        ...
        Click the lotus buds to help them bloom and reveal ancient wisdom
      </div>
