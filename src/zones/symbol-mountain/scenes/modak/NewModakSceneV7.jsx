...
const NewModakSceneMVPContent = ({
  ...
  return (
    <div data-zone="symbol-mountain">
      {/* Pause Button - Hidden during first VO (Listen state) */}
      <PauseButton
        visible={sceneState.welcomeShown && appState !== 'listen'}
          ...
          <div className="modak-game-container">
            ...
            {showDiscoveryFlip1 && (
              <SimpleDiscoveryOverlay
                ...
                onPowerStageEnter={() => {
                  // Play focus power VO, show button when done
            ...
            {showDiscoveryFlip2 && (
              <SimpleDiscoveryOverlay
                ...
                showButton={discoveryButtonVisible}
                onPowerStageEnter={() => {
                  // Play sharing power VO, show button when done
                  setDiscoveryButtonVisible(false);
            ...
            {showDiscoveryFlip3 && (
              <SimpleDiscoveryOverlay
                ...
                showButton={discoveryButtonVisible}
                onPowerStageEnter={() => {
                  // Play gratitude power VO, show button when done
                  setDiscoveryButtonVisible(false);
