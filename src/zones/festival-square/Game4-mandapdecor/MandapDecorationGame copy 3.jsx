...
const MISSION_MODES = {
  FIX_MANDAP: {
    ...
    name: 'Fix the Mandap',
    icon: '🔧',
    description: 'Some decorations are placed wrong! Can you fix them?'
  },
  LIGHT_CHALLENGE: {
    id: 'light-challenge',
    name: 'Light-Up Challenge',
    icon: '🪔',
    description: 'The sun is setting! Light 5 diyas before darkness!'
  },
  ECO_MANDAP: {
    id: 'eco-mandap',
    name: 'Eco Mandap',
  ...
  PUJA_PREP: {
    id: 'puja-prep',
    name: 'Puja Preparation',
    icon: '🙏',
    description: "Get ready for Ganesha's puja step-by-step!"
  }
};
...
const [showMissionCarousel, setShowMissionCarousel] = useState(false);
const [gameMode, setGameMode] = useState(null); // 'free-play' or mission id
...
const renderModeSelector = () => (
  <div className="mode-selector-overlay">
    <div className="mode-selector-container">
      <h1>🛕 How do you want to decorate?</h1>
      
      <div className="mode-buttons">
        <button 
          className="mode-button free-play" 
          onClick={() => {
        ...
        <button 
          ...
          onClick={() => {
            setShowModeSelector(false);
            setShowMissionCarousel(true);
          }}
        >
          <span className="mode-icon">⭐</span>
          <h3>Challenge Mode</h3>
          <p>Complete special missions!</p>
        </button>
      </div>
    </div>
  </div>
...
// MISSION CAROUSEL
const renderMissionCarousel = () => (
  <div className="mission-carousel-overlay">
      ...
      <div className="mission-cards">
        {Object.values(MISSION_MODES).map(mission => (
          <div 
            ...
            onClick={() => {
              setGameMode(mission.id);
              setShowMissionCarousel(false);
              // Mission logic will come later
              alert(`Selected: ${mission.name}\n(Full mission logic coming soon!)`);
            }}
          >
  ...
  // COMPLETE RETURN BLOCK WITH MODE SELECTOR INTEGRATION
...
return (
  <div className="mandap-game-container">
    ...
    {/* MISSION CAROUSEL - Shows when challenge selected */}
    {showMissionCarousel && renderMissionCarousel()}
    
    {/* ONLY SHOW GAME WHEN MODE IS SELECTED */}
    {gameMode && (
      <>
        {/* YOUR ENTIRE EXISTING GAME - UNCHANGED */}
