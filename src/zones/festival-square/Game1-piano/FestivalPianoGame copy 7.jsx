    ...
    return (
        <div className="festival-piano-game">
            <div className="intro-screen">
                <div className="intro-ganesha" style={{ backgroundImage: `url(${ganeshaGameScene})` }} />
                <div className="intro-speech-bubble">
                    Welcome to my music station! Let's make some festive melodies together!
                </div>
                <button 
                    className="intro-begin-button"
                    onClick={() => sceneActions.updateState({ currentMode: GAME_MODES.SELECTION })}
                >
