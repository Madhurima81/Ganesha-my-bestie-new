...
// ✅ NEW: Click-based sun healing (replaces drag/drop)
...
const handleContinueLearning = () => {
  ...
  if (symbolKey === 'suryakoti') {
    // Continue to Door 2
    setTimeout(() => {
      sceneActions.updateState({ phase: CAVE_PHASES.DOOR2_ACTIVE });
    }, 500);
    
  } else if (symbolKey === 'samaprabha') {
...
const handleRescueComplete = (success) => {
  ...
  // Continue based on which word was rescued
...
{(sceneState.phase === CAVE_PHASES.SUN_COLLECTION_INTRO || 
  ...
  <div className="sun-collection-area" id="sun-collection-area">
    <SunCollectionGameV1
      ...
      // ✅ ADD: Cave boundaries (adjust these to match your cave!)
 caveBounds={{
  top: '10%',     // Below top rock edge
  left: '20%',    // After left rock edge
  width: '50%',   // Circular opening
  height: '80%',    // Circular opening
}}
    />
  </div>
)}
