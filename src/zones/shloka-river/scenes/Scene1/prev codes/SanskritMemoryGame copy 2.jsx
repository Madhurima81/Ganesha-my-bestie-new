...
const ELEMENT_DATA = {
vakratunda: {
  singers: ['bud-va', 'bud-kra', 'bud-tun', 'bud-da'],
  clickers: ['baby-elephant-va', 'baby-elephant-kra', 'baby-elephant-tun', 'baby-elephant-da'],
  rewards: ['lotus-va', 'lotus-kra', 'lotus-tun', 'lotus-da'],
  positions: {
    singers: [
      { left: '25%', top: '45%' },
      { left: '35%', top: '55%' },
  ...
  mahakaya: {
    singers: ['seed-ma', 'seed-ha', 'seed-ka', 'seed-ya'],
...
const renderReward = (syllable, index) => {
  ...
  // Render elephant with existing approach + permanent activation
