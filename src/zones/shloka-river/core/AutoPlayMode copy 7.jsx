...
const AutoPlayMode = ({
  ...
  const handleExitToMenu = () => {
    console.log('🎮 Exiting auto-play');
    setShowPauseModal(false);
    clearAllTimers();
    
    // ⭐ KEY: We don't need to manually save here because MemoryGameEngine's 
    // handleEarlyExit will read the LAST SAVED state.
    // Since startNewRound() used our helper, the last saved state ALREADY has completedRounds.
