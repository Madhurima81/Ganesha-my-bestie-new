...
const DreamsWishesGameContent = ({ sceneState, sceneActions, isReload, onComplete, onNavigate, onBack }) => {
  ...
  const { startIdleTimer, stopIdleTimer, setCurrentPhase } = useVoiceGuidance(
    'about-me-hut', 'dreams-wishes', { enableMusic: false, idleTimeout: 20 }
  );
  ...
  return (
    <div className="dreams-wishes-game" data-zone="about-me-hut">
      ...
      <TocaBocaNav show={showSlideMenu} onClose={() => setShowSlideMenu(false)} zoneId="about-me-hut" onHome={() => onNavigate('home')} onHelp={() => { setShowSlideMenu(false); setShowHelpMenu(true); }} onStartFresh={() => { setShowSlideMenu(false); sceneActions.updateState({ gamePhase: 'intro', wish1Taps: 0, wish2Taps: 0, wish3Taps: 0, bowlStates: [false, false, false], trunkTaps: 0, childDreamDrawing: null }); }} isAudioOn={isAudioOn} onAudioToggle={toggleAudio} />
