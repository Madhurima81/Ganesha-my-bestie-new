  ...
  useEffect(() => {
    if (isReload && !reloadHandledRef.current) {
      ...
      if (gamePhase === 'wish1-intro') {
        ...
        if (isAudioOn) {
          phaseVoiceRef.current.wish1Intro = true;
          safeSetTimeout(() => speakLine(VOICE_LINES.wish1Intro, { moment: 'story' }), 300);
        }
        return;
      }
      ...
      if (gamePhase === 'wish2-intro') {
        ...
        if (isAudioOn) {
          phaseVoiceRef.current.wish2Intro = true;
          safeSetTimeout(() => speakLine(VOICE_LINES.wish2Intro, { moment: 'story' }), 300);
        }
        return;
      }
      ...
      if (gamePhase === 'wish3-intro') {
        ...
        if (isAudioOn) {
          phaseVoiceRef.current.wish3Intro = true;
          safeSetTimeout(() => speakLine(VOICE_LINES.wish3Intro, { moment: 'story' }), 300);
        }
        return;
      }
      ...
      if (gamePhase === 'dream-drawing') {
        ...
        if (isAudioOn) {
          phaseVoiceRef.current.dreamDrawing = true;
          safeSetTimeout(() => speakLine(VOICE_LINES.dreamDrawing, { moment: 'coregulation' }), 300);
        }
        return;
      }
      ...
      if (gamePhase === 'dream-clearing' && !dreamRevealed) {
        ...
        if (isAudioOn) {
          ...
          safeSetTimeout(() => speakLine(VOICE_LINES.dreamClearing, { moment: 'encouragement' }), 300);
        }
        return;
      }
      ...
      if (gamePhase === 'dream-clouded' || dreamRevealed) {
        ...
        if (isAudioOn) {
          if (dreamRevealed) {
            ...
            safeSetTimeout(() => speakLine(VOICE_LINES.dreamRevealed, { moment: 'celebration' }), 300);
          } else {
            phaseVoiceRef.current.dreamClouded = true;
            safeSetTimeout(() => speakLine(VOICE_LINES.dreamClouded, { moment: 'story' }), 300);
          }
        }
        return;
      }
      ...
      if (gamePhase === 'all-wishes-complete') {
        ...
        if (isAudioOn) {
          phaseVoiceRef.current.allWishesComplete = true;
          safeSetTimeout(() => speakLine(VOICE_LINES.allWishesComplete, { moment: 'celebration' }), 300);
        }
        return;
      }
