          ...
          <div className="game-modal-content">
            ...
            <div className="dream-card">
              ...
              <p className="dream-text">
                I have three special wishes for the world.<br />
...
{/* WISH 2 INTRO - SHARING */}
  ...
  {Array.from({length: 3}).map((_, i) => (
    ...
    >
      <img 
        src={wish2Taps > i ? wishBowlFull : wishBowlEmpty} 
        alt={`Bowl ${i + 1}`}
        className={`bowl-image ${wish2Taps === i + 1 ? 'bowl-glow-bounce' : ''}`}
      />
      
      {/* Show food particles when filling */}
      {wish2Taps === i + 1 && (
...
{(gamePhase === 'dream-clouded' || gamePhase === 'dream-clearing') && (
  <div className="dream-screen">
    ...
    <div className="speech-bubble-large">
      {trunkTaps === 0 ? (
        <>
          Oh no! Fear clouds are hiding your dream! 😰<br/>
          <strong>Tap my trunk 3 times to blow them away! 🌬️</strong>
        </>
      ) : trunkTaps < 3 ? (
        <>
          Keep going! Tap me again! 💪<br/>
