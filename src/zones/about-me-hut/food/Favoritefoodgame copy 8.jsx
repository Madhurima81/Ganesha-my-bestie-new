    ...
    <div className="favorite-food-game">
            ...
            <div className="game-modal-card">
              ...
              <div className="game-modal-icons">
                <div className="game-modal-icon-item">
                  <div className="game-modal-icon-circle"><img src={favIconFood} alt="Food" /></div>
                  <span className="game-modal-icon-label">Food</span>
                </div>
                <div className="game-modal-icon-item">
                  <div className="game-modal-icon-circle"><img src={favIconColor} alt="Color" /></div>
                  <span className="game-modal-icon-label">Color</span>
                </div>
                <div className="game-modal-icon-item">
                  <div className="game-modal-icon-circle"><img src={favIconActivity} alt="Activity" /></div>
      ...
      {sceneState.gamePhase === 'food-choice' && (
        <div className="choice-screen">
          ...
          <div className="fav-speech-bubble">Which one is my favorite? 🍬</div>
      ...
      {sceneState.gamePhase === 'child-friend-intro' && (
        <div className="intro-overlay">
          ...
          <div className="child-card">
            ...
            <button className="child-card-button" onClick={() => sceneActions.updateState({ gamePhase: 'child-friend-input' })}>Tap to tell! ✨</button>
          </div>
        </div>
      )}
      ...
      {sceneState.gamePhase === 'friend-celebration' && (
        <div className="choice-screen">
          ...
          <div className="fav-speech-bubble celebrate-pulse">
            Yay! {sceneState.childFriendName} is your best friend! 🎉<br /> Let me show you something special 💛
          </div>
        </div>
      )}
