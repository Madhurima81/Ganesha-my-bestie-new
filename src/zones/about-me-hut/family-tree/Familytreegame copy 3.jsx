...
import AnimationWrapper from '../../../lib/components/animation/Animationwrapper';
...
// Update your deityChoices like this:
  ...
  const handleChoiceSelection = (choice) => {
    if (choice.isCorrect) {
       setShowCelebration(selectedCircle);
  ...
  return (
    <div className="family-tree-game">
       {/* Add this block for the Magic Particles */}
  <div className="ambient-particles">
    <div className="ambient-particle p1"></div>
    <div className="ambient-particle p2"></div>
    <div className="ambient-particle p3"></div>
    <div className="ambient-particle p4"></div>
  </div>
...
{/* INTRO PHASE */}
  ...
  <AnimationWrapper animation="float" infinite={true} duration={3}>
  ...
  <AnimationWrapper animation="popIn" delay={0.1} duration={0.6}>
  ...
  <AnimationWrapper animation="popIn" delay={0.2} duration={0.6}>
    <div className="game-modal-icon-item">
  ...
  <AnimationWrapper animation="popIn" delay={0.3} duration={0.6}>
    <div className="game-modal-icon-item">
  ...
  {ganeshaFamily.map((m, i) => {
    const isFilled = placedGaneshaMembers.has(m.id);
    
    return (
      <AnimationWrapper 
        key={i}
        animation={isFilled ? "heartbeat" : "pulse"}
        infinite={true}
        duration={isFilled ? 1.5 : 2}
      >
        <span className={`progress-dot ${isFilled ? 'filled' : ''}`}>●</span>
      </AnimationWrapper>
    );
  })}
</div>
...
{showCelebration && (
  <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 9999 }}>
    {/* Regular celebration (single placement) */}
    {showCelebration !== 'all-complete' && (
      <>
        {/* Gold Stars */}
        <SparkleAnimation
          type="star"
        ...
        {/* Success Text */}
        <AnimationWrapper animation="tada" duration={1}>
          <div style={{
            position: 'fixed',
            top: '35%',
            left: '50%',
    ...
    {showCelebration === 'all-complete' && (
      <>
        ...
        {/* BIG Success Text */}
        <AnimationWrapper animation="tada" duration={1.5}>
          <div style={{
            position: 'fixed',
            top: '40%',
            left: '50%',
            ...
            <div style={{ 
              ...
              fontSize: '64px', 
              color: '#FFD700',
              textShadow: '0 0 30px rgba(255, 215, 0, 1), 0 0 20px rgba(255, 107, 107, 0.8)',
              marginBottom: '10px'
            }}>
              Amazing Job!
            </div>
            <div style={{ 
              ...
              You completed Ganesha's family tree! 🌳
            </div>
          </div>
        </AnimationWrapper>
      </>
  ...
  <AnimationWrapper animation="pulse" infinite={true} duration={2}>
...
<div className="choice-image">
  ...
  <AnimationWrapper 
    ...
    duration={3}
  >
    <button className="member-card" onClick={() => handleSelectFamilyType(type)}>
  ...
  <AnimationWrapper animation="pulse" infinite={true} duration={1.5}>
    <button className="done-tray-btn" onClick={() => setGamePhase('sideBySide')}>
      Done! ✓
    </button>
  </AnimationWrapper>
)}
                ...
                {ganeshaFamily.map(member => {
                  ...
                  return (
                    <div key={member.id} className="tree-member-mini" style={member.position}>
                      {typeof deity?.image === 'string' && deity?.image.startsWith('http') ? (
