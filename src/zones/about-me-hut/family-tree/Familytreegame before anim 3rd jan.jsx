...
const FamilyTreeGame = ({ onComplete, onBack }) => {
  ...
  const deityChoices = {
    father: [
      { id: 'shiva', name: 'Shiva Ji', image: shivaImg, subtitle: 'King of Yoga', isCorrect: true },
      { id: 'vishnu', name: 'Vishnu Ji', image: '🔱', subtitle: 'Preserver of World', isCorrect: false },
      { id: 'brahma', name: 'Brahma Ji', image: '🪷', subtitle: 'Creator of World', isCorrect: false }
    ],
    mother: [
      { id: 'parvati', name: 'Parvati Mata', image: parvatiImg, subtitle: 'Goddess of Power', isCorrect: true },
      { id: 'lakshmi', name: 'Lakshmi Mata', image: '💰', subtitle: 'Goddess of Prosperity', isCorrect: false },
      { id: 'saraswati', name: 'Saraswati Mata', image: '📚', subtitle: 'Goddess of Knowledge', isCorrect: false }
    ],
    brother: [
      { id: 'kartikeya', name: 'Kartikeya', image: kartikeyaImg, subtitle: 'Warrior God', isCorrect: true },
      { id: 'hanuman', name: 'Hanuman Ji', image: '🐒', subtitle: 'Devotee of Rama', isCorrect: false },
      { id: 'krishna', name: 'Krishna Ji', image: '🪈', subtitle: 'Avatar of Vishnu', isCorrect: false }
    ]
  };
                  ...
                  {flippedMember !== member.id ? (
                    <div className="deity-front">
                      <div className="deity-circle">
                        {typeof getPlacedDeityImage(member.id)?.image === 'string' && 
                         getPlacedDeityImage(member.id)?.image.startsWith('http') ? (
                          <img src={getPlacedDeityImage(member.id).image} alt={getPlacedDeityImage(member.id).name} className="deity-image" />
                        ) : (
                  ...
                  {currentChoices.map(choice => (
                    ...
                    >
                      <div className="choice-image">
                        {typeof choice.image === 'string' && choice.image.startsWith('http') ? (
            ...
            <div className="modal-overlay" onClick={() => setShowFunFactModal(null)}>
              <div className="fun-fact-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-deity-image">
                  {typeof showFunFactModal.image === 'string' && showFunFactModal.image.startsWith('http') ? (
