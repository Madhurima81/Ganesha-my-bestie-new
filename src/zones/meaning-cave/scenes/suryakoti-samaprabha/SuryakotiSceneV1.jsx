...
// ✅ ADD HERE - AFTER the popup handling, BEFORE the default case
// ✅ ADD: Handle Door 1 completed but sun collection not started
else if (sceneState.door1Completed && !sceneState.sunCollectionStarted) {
  console.log('🔄 SURYAKOTI: Door 1 completed but sun collection not started - starting game');
  sceneActions.updateState({
...
sceneActions.updateState({
  phase: CAVE_PHASES.SUN_COLLECTION_INTRO // ← Game starts immediately!
});
