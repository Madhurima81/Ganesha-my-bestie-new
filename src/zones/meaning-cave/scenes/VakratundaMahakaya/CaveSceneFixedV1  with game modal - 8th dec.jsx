...
const CaveSceneContent = ({
  ...
  const [showDoor1Modal, setShowDoor1Modal] = useState(false);
const [showDoor2Modal, setShowDoor2Modal] = useState(false);
...
{showDoor1Modal && (
  <DoorUnlockedModal 
    ...
    onStart={handleDoor1Complete}
    titleColor="#FF6B35"
    buttonColor="#FFA500"
    buttonTextColor="#FFFFFF"
    cardBorderColor="#FFA500"
  />
)}

{/* Door 2 Unlocked Modal */}
{showDoor2Modal && (
  <DoorUnlockedModal 
    show={true}
    title="Door Unlocked!"
...
<DoorComponent 
  ...
  onAudioComplete={() => {              // ✅ Called after word audio finishes
    console.log('🎵 Audio complete - showing Door 1 modal');
    setTimeout(() => {
      setShowDoor1Modal(true);
    }, 300);
  }}
  ...
  isResuming={isReload}
  modalOpen={showPowerModal || showRescueModal || showCenteredSymbol || showDoor1Modal}
/>        </div>
            )}
