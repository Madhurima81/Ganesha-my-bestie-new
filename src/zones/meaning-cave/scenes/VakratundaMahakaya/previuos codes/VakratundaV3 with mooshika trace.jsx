...
{/* Draggable Mooshika */}
{/* Enhanced Mooshika with trail effect */}
<g 
  transform={`translate(${sceneState.mooshikaPosition.x - 25}, ${sceneState.mooshikaPosition.y - 25})`}
  onMouseDown={handleMooshikaStart}
  onTouchStart={handleMooshikaStart}
  style={{ 
    cursor: sceneState.mooshikaDragging ? 'grabbing' : 'grab',
    filter: sceneState.mooshikaDragging ? 'drop-shadow(0 0 10px #FFD700)' : 'none'
  }}
>
  {/* Glowing trail when moving */}
  {sceneState.mooshikaDragging && (
    <circle 
      cx="25" 
      cy="25" 
      r="40" 
  ...
  {/* Mooshika image */}
  <image 
    href={mooshikaTracing} 
    x="5" 
    y="5" 
    width="40" 
    height="40"
    style={{ 
      filter: sceneState.mooshikaDragging ? 'brightness(1.3) saturate(1.2)' : 'brightness(1)',
      pointerEvents: 'none'
    }}
  />
  
  {/* Progress indicator on Mooshika */}
  {sceneState.traceProgress > 0 && (
    <circle 
      cx="25" 
      cy="25" 
      ...
      stroke="#00ff88" 
      strokeWidth="4"
      strokeDasharray={`${sceneState.traceProgress * 1.25} 125`}
    ...
    />
          ...
          {/* Global Mooshika Drag Overlay */}
{/* Global Mooshika Drag Overlay - FULL COVERAGE */}
{sceneState.tracingStarted && (
  <div
    style={{
      ...
      width: '100%',
      height: '100%',
      zIndex: 15,  // ✅ Higher than SVG
      pointerEvents: 'auto',  // ✅ Always active
      cursor: sceneState.mooshikaDragging ? 'grabbing' : 'grab'
    }}
    onMouseMove={handleMooshikaMove}
    onMouseUp={handleMooshikaEnd}
    onTouchMove={handleMooshikaMove}
    onTouchEnd={handleMooshikaEnd}
  />
)}
