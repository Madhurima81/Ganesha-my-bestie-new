  ...
  return (
    <div className="tracing-area" id="tracing-area">
      <ClickDotsPathGame
        ...
        disabled={false}
        showDebug={false}  // Set to true to see progress
      />
    </div>
  );
};
...
const handleRescueComplete = (success) => {
  ...
  // Unlock the word based on which rescue was completed
...
{!showPowerModal && !showRescueModal && !showCenteredSymbol && !showStoryModal && sceneState?.welcomeShown && (  <>
    {/* Door 1 Active */}
    {sceneState.phase === CAVE_PHASES.DOOR1_ACTIVE && 
     !sceneState.door1Completed && (
