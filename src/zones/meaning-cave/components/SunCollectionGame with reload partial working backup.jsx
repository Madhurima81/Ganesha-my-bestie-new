...
const SunCollectionGame = ({ 
  ...
  // ✅ ADD: Resume logic for reload handling
  useEffect(() => {
    if (isResuming && resumeStarted && resumeCollectedSuns > 0) {
      ...
      console.log('✅ SUN COLLECTION: Resume complete', {
  ...
  // ✅ MODIFIED: Auto-start logic (don't override resume)
  useEffect(() => {
    if (autoStart && !isResuming) {
      console.log('🌞 Auto-starting sun collection for scene integration');
      setGameActive(true);
    }
  }, [autoStart, isResuming]); // ✅ ADD isResuming dependency
