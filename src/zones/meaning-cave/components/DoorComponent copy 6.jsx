...
if (allPlaced && !allSyllablesPlaced && !isCompleted && syllables.length > 0 && !hasPlayedWordAudioRef.current) {
    ...
    hasPlayedWordAudioRef.current = true;  // ✅ ADD THIS LINE
    setSparkleType('completion');
    setShowSparkles(true);

    // ✅ WAIT 1 second (500ms for syllable + 500ms buffer) before playing word
    setTimeout(() => {
    ...
    }, 1000); // ✅ KEY FIX: Wait 1 second for syllable audio to finish
  }
