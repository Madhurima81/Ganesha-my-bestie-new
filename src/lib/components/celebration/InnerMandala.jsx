...
const OUTER_PETAL_SPARKLES = {
  1: [{ x: '48%', y: '15%' }, { x: '55%', y: '14%' }, { x: '42%', y: '18%' }],
  2: [{ x: '67%', y: '22%' }, { x: '73%', y: '27%' }, { x: '61%', y: '18%' }],
  3: [{ x: '78%', y: '40%' }, { x: '82%', y: '46%' }, { x: '75%', y: '33%' }],
  4: [{ x: '67%', y: '66%' }, { x: '73%', y: '72%' }, { x: '61%', y: '61%' }],
  5: [{ x: '47%', y: '77%' }, { x: '54%', y: '81%' }, { x: '40%', y: '74%' }],
  6: [{ x: '28%', y: '66%' }, { x: '22%', y: '72%' }, { x: '33%', y: '61%' }],
  7: [{ x: '18%', y: '40%' }, { x: '14%', y: '47%' }, { x: '21%', y: '34%' }],
  8: [{ x: '31%', y: '23%' }, { x: '36%', y: '18%' }, { x: '28%', y: '29%' }],
};
...
const SYMBOL_STAGGER_MS = 850;
const SYMBOL_CENTER_DELAY_MS = 260;
const SYMBOL_TRAVEL_MS = 1500;
