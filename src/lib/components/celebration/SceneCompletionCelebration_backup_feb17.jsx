                ...
                <>
                  ...
                  <div className="backpack-symbols-overlay">
                    {symbolsInContainer.map((symbol) => (
                      <div
                        key={symbol}
                        className={`backpack-symbol ${symbolData[symbol] ? 'backpack-symbol-tappable' : ''}`}
                  ...
                  {Object.keys(symbolData).length > 0 && symbolsInContainer.length > 0 && (
                    <p className="backpack-symbol-hint">Tap the symbols to learn more!</p>
                  )}
                </>
