// CleanProfileSelector.jsx - FINAL VERSION WITHOUT BACK BUTTON
...
const CleanProfileSelector = ({ 
  ...
  return (
    <div className="clean-profile-overlay">
      ...
      {/* Ganesha Welcome Character */}
      <div className="clean-ganesha-welcome">
        <img 
          src="/images/welcome-ganesha.png" 
          alt="Ganesha"
          className="clean-ganesha-welcome-image"
        />
      </div>
