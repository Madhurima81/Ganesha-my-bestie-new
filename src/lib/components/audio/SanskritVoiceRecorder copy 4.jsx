                ...
                <div key={recording.id} style={{
                  ...
                  <div style={{ display: 'flex', gap: '8px' }}>
                    ...
                    <button
                      ...
                      style={{
                        background: (playingRecordingId === recording.id && currentPlayingAudio && !currentPlayingAudio.paused)
                          ? currentTheme.danger 
                    ...
                    >
                      {(playingRecordingId === recording.id && currentPlayingAudio && !currentPlayingAudio.paused) ? '⏸️' : '▶️'}
                    </button>
                  ...
                  {playingRecordingId === recording.id && audioDuration > 0 && (
                    <div style={{ 
                      ...
                      <p style={{ 
                        ...
                        {formatTime(Math.floor(audioProgress))} / {formatTime(Math.floor(recording.duration || audioDuration))}
                      </p>
                    </div>
                  )}
                </div>
