// lib/components/ui/Header/UnifiedHeaderV2.jsx
// Unified header V2 - SOLID STICKER STYLE with 3D shadow
// Auto-progresses based on game rounds (stars per phase)

import React, { useEffect, useState } from 'react';
import './UnifiedHeaderV2.css';

const UnifiedHeaderV2 = ({
  zone = 'meaning-cave',  // 'shloka-river', 'symbol-mountain', 'meaning-cave', 'about-me-hut', 'festival-square'
  title,
  currentRound = 0,
  totalRounds = 3,
  className = ''
